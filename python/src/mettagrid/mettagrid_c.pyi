...
from typing import Any, Optional, TypeAlias, TypedDict, Union, overload
...
class TagQueryConfig:
    def __init__(self) -> None: ...
    tag_id: int
    max_items: Any  # GameValueConfig variant (ConstValueConfig for static int, or any GameValue)
    ...
    def add_periodic_filter(self, filter: "PeriodicFilterConfig") -> None: ...
...
class RaycastQueryConfig:
    ...
    def add_blocker_tag_prefix_filter(self, filter: TagPrefixFilterConfig) -> None: ...
...
class ClosureQueryConfig:
    ...
    def add_edge_periodic_filter(self, filter: "PeriodicFilterConfig") -> None: ...
    ...
    def add_result_periodic_filter(self, filter: "PeriodicFilterConfig") -> None: ...
...
def make_query_config(
    query: TagQueryConfig | ClosureQueryConfig | FilteredQueryConfig | RaycastQueryConfig,
) -> QueryConfigHolder: ...
...
class TargetLocEmptyFilterConfig:
    def __init__(self) -> None: ...

class TargetIsUsableFilterConfig:
    def __init__(self) -> None: ...
...
class RelocateMutationConfig:
    def __init__(self) -> None: ...

class SwapMutationConfig:
    def __init__(self) -> None: ...

class UseTargetMutationConfig:
    def __init__(self) -> None: ...

class PushObjectMutationConfig:
    def __init__(self) -> None: ...

class SetRelativeTargetMutationConfig:
    def __init__(self) -> None: ...
    direction: int
    distance: int

class SpawnObjectMutationConfig:
    def __init__(self) -> None: ...
    object_type: str
...
class QueryPlaceAdjacentMutationConfig:
    def __init__(self) -> None: ...
    target: EntityRef
    def set_query(self, query: QueryConfigHolder) -> None: ...
...
class HandlerConfig:
    ...
    def add_query_place_adjacent_mutation(self, mutation: QueryPlaceAdjacentMutationConfig) -> None: ...
    ...
    def add_use_target_mutation(self, mutation: UseTargetMutationConfig) -> None: ...
    def add_push_object_mutation(self, mutation: PushObjectMutationConfig) -> None: ...
    def add_set_relative_target_mutation(self, mutation: SetRelativeTargetMutationConfig) -> None: ...
    def add_spawn_object_mutation(self, mutation: SpawnObjectMutationConfig) -> None: ...
    def add_raycast_spawn_mutation(self, mutation: RaycastSpawnMutationConfig) -> None: ...
    def add_target_loc_empty_filter(self, filter: TargetLocEmptyFilterConfig) -> None: ...
    def add_periodic_filter(self, filter: PeriodicFilterConfig) -> None: ...
    def add_target_is_usable_filter(self, filter: TargetIsUsableFilterConfig) -> None: ...
...
class MettaGrid:
    ...
    def resolve_game_value(self, game_value: GameValueConfig) -> int: ...
    def resolve_game_values(self) -> dict[str, int]: ...
