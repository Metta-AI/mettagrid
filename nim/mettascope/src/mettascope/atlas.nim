...
proc buildSilkyAtlas*(): AtlasBuilder =
  ...
  result.addOptionalDir(dataDir / "amongus/profiles/", dataDir & "/")
  ...
  result.addOptionalDir(dataDir / "amongus/agents/", dataDir & "/")
  result.addOptionalDir(dataDir / "amongus/agents/", dataDir / "amongus/")
  result.addDir(dataDir / "objects/", dataDir & "/")
  result.addOptionalDir(dataDir / "amongus/objects/", dataDir & "/")
  ...
  result.addOptionalDir(dataDir / "amongus/minimap/", dataDir & "/")
