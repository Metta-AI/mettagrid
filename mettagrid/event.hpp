...
public:
    ...
    virtual void handle_event(cpp_GridObjectId object_id, EventArg arg) = 0;
};
...
public:
    ...
    void schedule_event(EventId event_id, unsigned int delay, cpp_GridObjectId object_id, EventArg arg)
    {
        Event event;
