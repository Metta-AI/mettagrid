...
public:
    ...
    {
        CppGridObject::cpp_init(type_id, CppGridLocation(r, c, GridLayer::Object_Layer));
    ...
    Converter(cpp_GridCoord r, cpp_GridCoord c, ObjectConfig cfg) : Converter(r, c, cfg, ObjectType::GenericConverterT)
    {
    }
    ...
    void cpp_obs(cpp_ObsType* obs, const std::vector<unsigned int>& offsets) const override
    {
        obs[offsets[0]] = 1;
    ...
    static std::vector<std::string> feature_names(cpp_TypeId type_id)
    {
